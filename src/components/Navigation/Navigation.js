      ...
      <div className={`nav ${props.isOpen ? `nav_opened` : ``}`}>
        ...
        <div className="nav__container">
          ...
          <ul className="nav__list">
            ...
            <li className="nav__element">
              <Link to="/terms" className="nav__link" onClick={props.changeState}>
                Доставка и оплата
              </Link>
            </li>
            <li className="nav__element">
              <Link to="/return" className="nav__link" onClick={props.changeState}>
                Возврат
              </Link>
            </li>
            {/* <li className="nav__element">
            ...
            <li className="nav__element">
              <Link to="/news" className="nav__link" onClick={props.changeState}>
                Новости
              </Link>
            </li>
            {/* <li className="nav__element">
