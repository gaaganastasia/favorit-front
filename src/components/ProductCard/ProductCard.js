...
function ProductCard(props) {
  ...
  const isInCart = props.cartItems && props.cartItems.some((p) => p._id === props.product._id);

  return (
    <div className="catalog__item">
      <Link to={props.linkPath} className="catalog__item-img-link">
        <img src={props.product.mainImage} alt="Фото товара" className="catalog__item-img"></img>
      </Link>
